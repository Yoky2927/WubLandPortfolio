...
const AdminDashboard = () => {
  ...
  const handleUserAction = (user, action) => {
    // Prevent admin from modifying super admins and other admins
    if (user.role === "super_admin") {
      alert("You cannot modify Super Admins");
      return;
    }

    if (user.role === "admin" && user.id !== user?.id) {
      // Changed currentUser to user
      alert("You cannot modify other Admins");
      return;
    }
                        ...
                        >
                          ...
                          >
                            <div className="flex gap-2">
                              {/* Prevent actions on super admins and other admins */}
                              {user.role !== "super_admin" &&
                              (user.role !== "admin" ||
                                user.id === user?.id) ? ( // Changed currentUser to user
                                <>
                                  <button
                                    onClick={() =>
                                      handleUserAction(
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm">Support Ticket Alerts</span>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        className="sr-only peer"
              ...
              >
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">1.2 GB / 10 GB</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <button className="p-4 bg-green-100 text-green-700 rounded-lg hover:bg-green-200 transition-colors">
                  ...
                  <span className="text-sm font-medium">Property Stats</span>
                </button>
                <button className="p-4 bg-amber-100 text-amber-700 rounded-lg hover:bg-amber-200 transition-colors">
